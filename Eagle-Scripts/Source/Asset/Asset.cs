...
namespace Eagle
{
    ...
    public class AssetMaterial : Asset
    {
        ...
        public Material GetMaterial()
        {
            ...
            GetMaterial_Native(m_GUID,
                ...
                out Color4 tint, out Color3 emissiveIntensity, out Vector2 tilingFactor, out MaterialBlendMode blendMode, out bool bDoubleSided,
        ...
        public void SetMaterial(Material value)
        {
            ...
            SetMaterial_Native(m_GUID,
                ...
                ref value.TintColor, ref value.EmissiveIntensity, ref value.TilingFactor, value.BlendMode, value.bDoubleSided,
        ...
        internal static extern void SetMaterial_Native(in GUID assetID,
            ...
            ref Color4 tint, ref Color3 emissiveIntensity, ref Vector2 tilingFactor, MaterialBlendMode blendMode, bool bDoubleSided,
    ...
    public class AssetBehaviorGraph : Asset
    {
        internal AssetBehaviorGraph(GUID guid) : base(AssetType.BehaviorGraph, guid)
        {
        }

        public AITaskManager CreateTaskManager()
        {
            CreateTaskManager_Native(m_GUID, out AITaskManager manager);
            return manager;
        }
