...
void main()
{
    ...
    const vec3 lambert_albedo = albedo / PI;
    ...
    // Directional light
    {
        ...
        Lo += EvaluatePBR(lambert_albedo, incoming, V, normal, F0, metallness, roughness, g_DirectionalLight.LightColor, 1.f);
    }
    ...
    resultColor = ApplyGamma(resultColor, 1.f / g_Gamma);
