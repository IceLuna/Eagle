...
namespace Eagle
{
	...
	Ref<Texture2D> EditorResources::s_SceneSequenceIcon;
	...
	void EditorResources::Init()
	{
		...
		s_SceneSequenceIcon = Texture2D::Create(Application::GetCorePath() / "assets/textures/Editor/scenesequenceicon.png");
