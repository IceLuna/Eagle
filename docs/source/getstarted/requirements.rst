...
- PC
- GPU that supports ``Vulkan 1.3``. `This <https://docs.vulkan.org/guide/latest/checking_for_support.html>`_ guide will help you to determine what Vulkan version is supported by your system
...
.. note::
	The engine may not run on integrated GPUs because usually they lack features and have limitations. But it's worth trying though :)
