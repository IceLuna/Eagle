...
namespace Eagle
{
	...
	public:
		...
		static void FilterPose(const SkeletalPose& pose, const BoneNode& node, const std::string& boneName, SkeletalPose* outPose);
		...
		static void FinalizePose(SkeletalPose& pose, const BoneNode& node, const glm::mat4& parentTransform);
