...
namespace Eagle
{
	...
	void RenderText2DTask::InitPipeline()
	{
		...
		state.VertexShader = Shader::Create(Application::GetCorePath() / "assets/shaders/text2D.vert", ShaderType::Vertex, noObjectIDDefine);
		state.FragmentShader = Shader::Create(Application::GetCorePath() / "assets/shaders/text2D.frag", ShaderType::Fragment, noObjectIDDefine);
		...
		state.VertexShader = Shader::Create(Application::GetCorePath() / "assets/shaders/text2D.vert", ShaderType::Vertex);
		state.FragmentShader = Shader::Create(Application::GetCorePath() / "assets/shaders/text2D.frag", ShaderType::Fragment);
