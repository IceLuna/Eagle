...
namespace Eagle
{
	...
	void RenderBillboardsTask::InitPipeline()
	{
		...
		state.VertexShader = Shader::Create("billboard.vert", ShaderType::Vertex, vertexDefines);
		state.FragmentShader = Shader::Create("billboard.frag", ShaderType::Fragment, fragmentDefines);
